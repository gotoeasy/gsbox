...
func usage() {
	...
	fmt.Println("  -bs, --block-size <num>            specify the block size(4096~640000) for spx output (default is 67600)")
	...
	fmt.Println("  -ki, --kmeans-iterations <num>     specify the kmeans iterations, default is set by quality level")
	fmt.Println("  -kn, --kmeans-nearest-nodes <num>  specify the kmeans nearest nodes, default is set by quality level")
